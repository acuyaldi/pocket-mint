...
- runtime/edge.js
- telegram-callback.integration.test.ts
- library.js
- Decimal
- wasm-engine-edge.js
...
- Global Constraints
- monthly-spending-summary.handler.ts
...
- `buildApp()` --indirect_call--> `errorHandler()`  [INFERRED]
  test/analyticsControllerBoundary.test.ts → src/middlewares/error.middleware.ts
- `buildApp()` --indirect_call--> `errorHandler()`  [INFERRED]
...
Cohesion: 0.07
Nodes (39): computeConfidence(), groupByCategory(), KIND_CONFIDENCE, pickBest(), ScoredMatch, scoreMatches(), findMatches(), KeywordMatch (+31 more)
...
Cohesion: 0.11
Nodes (20): computeFinalMonthlyAmount(), computeInstallmentPlan(), HUNDRED, InstallmentPlan, InstallmentPlanInput, toMoney(), ALLOWED_SOURCE_TYPES, createInstallmentPaymentService() (+12 more)
...
### Community 44 - "a"
Cohesion: 0.08
Nodes (14): a(), ar(), bi(), fromContent(), gl(), hn(), Je(), K() (+6 more)

### Community 45 - "reconciliation.ts"
Cohesion: 0.14
Nodes (20): AuditOptions, AuditReport, AuditTransaction, auditWalletBalances(), AuditWalletSnapshot, classify(), Confidence, DriftClassification (+12 more)

### Community 46 - ".slice"
Cohesion: 0.08
Nodes (34): cn(), Da(), enabled(), Er(), eu(), Fa(), Fl(), gi() (+26 more)
...
### Community 71 - "write"
Cohesion: 0.13
Nodes (31): addMarginSymbol(), afterNextNewline(), compare(), copy(), G(), getCurrentLineLength(), getPrintWidth(), indent() (+23 more)
...
### Community 132 - "write"
Cohesion: 0.22
Nodes (18): Cr(), addMarginSymbol(), afterNextNewline(), getCurrentLineLength(), getPrintWidth(), indent(), newLine(), setColor() (+10 more)
...
### Community 198 - "monthly-spending-summary.handler.ts"
Cohesion: 0.10
Nodes (16): handleMonthlySpendingSummary(), MonthlyCategoryBreakdown, MonthlySpendingSummaryInput, MonthlySpendingSummaryOutput, num(), parseMonth(), ZERO, formatMonthId() (+8 more)
...
### Community 272 - "transactionBalance.ts"
Cohesion: 0.22
Nodes (13): applyBalanceDeltas(), balanceDeltas(), BalanceEffectInput, computeBalanceEffect(), reconcileWalletBalances(), reverseBalanceEffect(), update(), WalletBalanceClient (+5 more)

### Community 273 - "prismaBillingMigration.test.ts"
Cohesion: 0.50
Nodes (3): migrationPath, root, schemaPath

### Community 274 - "recurringReminderEngine.service.ts"
Cohesion: 0.27
Nodes (5): createRecurringReminderEngineService(), recurringReminderEngineService, RecurringReminderEnginePrismaClient, RecurringReminderEvent, template
