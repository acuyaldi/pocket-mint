...
import type { InteractionKeyboard } from '../channels/interaction.types';
...
export function renderInlineKeyboard(keyboard: InteractionKeyboard): TelegramInlineKeyboard {
  return {
